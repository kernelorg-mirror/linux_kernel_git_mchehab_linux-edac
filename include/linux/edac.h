 ...
 *
 * Branch:		Not all memory controllers have it. It is the highest
 ...
 *			the data flows to the CPU using a 128 bits parallel access.
 *
 * Chip-select row:	This is the name of the DRAM signal used to select the
 *			DRAM chips to be used. It may not be visible by the memory
 *			controller, as some DIMM types have a memory buffer that
 *			can hide direct access to it from the Memory Controller.
 *			On devices where it is visible, it selects the DIMM rank
 *			that it is accessed by the memory controller.
 *
